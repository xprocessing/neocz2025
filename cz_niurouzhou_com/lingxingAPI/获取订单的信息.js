...
fetch('https://erp.lingxing.com/api/platforms/oms/order_list/detail?global_order_no=103638993756323887&req_time_sequence=%2Fapi%2Fplatforms%2Foms%2Forder_list%2Fdetail$$1', {
    method: 'GET',
    headers: header_data,    
    credentials: 'include'
})
    ...
    .then(data => {
        console.log(data);
        console.log(data.data.order_info);
    })
